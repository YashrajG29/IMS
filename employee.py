...
class employeeClass:
    def __init__(self, root):
        ...
        title = Label(self.root, text="Employee Details", font=("Times new roman", 15, "bold"), bg="black",
        ...
        txt_gender = ttk.Combobox(self.root, textvariable=self.var_gender,
        ...
        self.txt_address = Entry(self.root, font=("goudy old style", 15), bg="light yellow")
        ...
        btn_add = Button(self.root, text="Save", command=self.add, font=("Times new roman", 15, "bold"),
                         bg="#2196f3", fg="white", cursor="hand2").place(x=500, y=305, width=110, height=28)
        btn_update = Button(self.root, text="Update", command=self.update, font=("Times new roman", 15, "bold"),
                            bg="green", fg="white", cursor="hand2").place(x=620, y=305, width=110, height=28)
        btn_delete = Button(self.root, text="Delete", command=self.delete, font=("Times new roman", 15, "bold"),
                            bg="red", fg="white", cursor="hand2").place(x=740, y=305, width=110, height=28)
        btn_clear = Button(self.root, text="Clear", command=self.clear, font=("Times new roman", 15, "bold"),
                           bg="black", fg="white", cursor="hand2").place(x=860, y=305, width=110, height=28)
    ...
    def get_data(self, ev):
        ...
        self.txt_address.insert(0, row[9])
